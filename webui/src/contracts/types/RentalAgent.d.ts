...
export interface RentalAgentContract
  extends Truffle.Contract<RentalAgentInstance> {
  "new"(
    _token: string,
    _estateAgent: string,
    meta?: Truffle.TransactionDetails
  ): Promise<RentalAgentInstance>;
}
...
export interface RentalAgentInstance extends Truffle.ContractInstance {
   ...
   */
  removeAdmin: {
    (oldAdmin: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      oldAdmin: string,
